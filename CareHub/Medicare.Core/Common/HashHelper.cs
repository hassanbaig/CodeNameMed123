...
namespace CareHub.Core.Common
{
    public static class HashHelper
    {
        ...
        public static Hashtable PracticeEditDetailsAddPracticeContacts(int operationType, string userId, long providerId, string primaryPhone, string primaryEmail, string websiteAddress, string secondaryPhone, string secondaryEmail)
        {
            Hashtable practiceEditDetails = new Hashtable();
            practiceEditDetails["OperationType"] = operationType;
            practiceEditDetails["UserId"] = userId;
            practiceEditDetails["ProviderId"] = providerId;
            practiceEditDetails["PracticeContactsPrimaryPhone"] = primaryPhone;
            practiceEditDetails["PracticeContactsSecondaryPhone"] = secondaryPhone;
            practiceEditDetails["PracticeContactsPrimaryEmail"] = primaryEmail;
            practiceEditDetails["PracticeContactsSecondaryEmail"] = secondaryEmail;
            practiceEditDetails["PracticeContactsWebsiteAddress"] = websiteAddress;
            return practiceEditDetails;
        }
