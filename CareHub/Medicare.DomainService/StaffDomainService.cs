        ...
        {            
            try
            {
                if (domainModel != null)
                {
                    ...
                    {
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_SPECIALIZATIONS:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(CareHub.UnitOfWork.DoctorEditDetailsUOW));
                            unitOfWork.Save(doctorEditDetails);
                            //unitOfWork.Commit();
                            doctorEditDetails.ResponseMessage = "Information has been added successfully.";
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_LANGUAGES:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(CareHub.UnitOfWork.DoctorEditDetailsUOW));
                            unitOfWork.Save(doctorEditDetails);
                            //unitOfWork.Commit();
        ...
        {                      
            try
            {
                if (domainModel != null)
                {
                    ...
                    switch (domainModelType)
                    {
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_DETAILS:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            ...
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_CONTACTS:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            ...
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_CONSULTATION:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(CareHub.UnitOfWork.DoctorEditDetailsUOW));
                            unitOfWork.Update(doctorEditDetails);
                            unitOfWork.Commit();
                        ...
                        case CareHub.Factory.Enumerations.DomainModelEnum.EDIT_PROFILE:
                            ...
                            {
                                unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(CareHub.UnitOfWork.EditProfileUOW));
                                unitOfWork.Update(editProfile);
                                unitOfWork.Commit();
                                editProfile.ResponseMessage = "Profile updated successfully.";
                            }
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_TO_SPECIALIZATIONS:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(CareHub.UnitOfWork.DoctorEditDetailsUOW));
                            unitOfWork.Update(doctorEditDetails);
                            unitOfWork.Commit();
                            doctorEditDetails.ResponseMessage = "Information has been added successfully.";
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_TO_LANGUAGES:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(CareHub.UnitOfWork.DoctorEditDetailsUOW));
                            unitOfWork.Update(doctorEditDetails);
                            unitOfWork.Commit();
                            doctorEditDetails.ResponseMessage = "Information has been added successfully.";
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_TREATMENTS:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            ...
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_EDIT_TREATMENTS:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            ...
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_EDUCATION:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(CareHub.UnitOfWork.DoctorEditDetailsUOW));
                            unitOfWork.Update(doctorEditDetails);
                            unitOfWork.Commit();
                            doctorEditDetails.ResponseMessage = "Information has been added successfully.";
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_EXPERIENCE:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(CareHub.UnitOfWork.DoctorEditDetailsUOW));
                            unitOfWork.Update(doctorEditDetails);
                            unitOfWork.Commit();
                            doctorEditDetails.ResponseMessage = "Information has been added successfully.";
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_AFFILIATION:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(CareHub.UnitOfWork.DoctorEditDetailsUOW));
                            unitOfWork.Update(doctorEditDetails);
                            unitOfWork.Commit();
                            doctorEditDetails.ResponseMessage = "Information has been added successfully.";
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_AWARD:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(CareHub.UnitOfWork.DoctorEditDetailsUOW));
                            unitOfWork.Update(doctorEditDetails);
                            unitOfWork.Commit();
        ...
        {   
            try
            {
                if (domainModel != null)
                {
                    ...
                    switch (domainModelType)
                    {
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_REMOVE_FROM_SPECIALIZATIONS:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(CareHub.UnitOfWork.DoctorEditDetailsUOW));
                            ...
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_REMOVE_FROM_LANGUAGES:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(CareHub.UnitOfWork.DoctorEditDetailsUOW));
                            unitOfWork.Delete(doctorEditDetails);
                            unitOfWork.Commit();
                            doctorEditDetails.ResponseMessage = "Information has been removed successfully.";
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_REMOVE_FROM_TREATMENTS:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(CareHub.UnitOfWork.DoctorEditDetailsUOW));
                            unitOfWork.Delete(doctorEditDetails);
                            unitOfWork.Commit();
                            doctorEditDetails.ResponseMessage = "Information has been removed successfully.";
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_REMOVE_FROM_EDUCATION:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(CareHub.UnitOfWork.DoctorEditDetailsUOW));
                            unitOfWork.Delete(doctorEditDetails);
                            unitOfWork.Commit();
                            doctorEditDetails.ResponseMessage = "Information has been removed successfully.";
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_REMOVE_FROM_EXPERIENCE:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(CareHub.UnitOfWork.DoctorEditDetailsUOW));
                            unitOfWork.Delete(doctorEditDetails);
                            unitOfWork.Commit();
                            doctorEditDetails.ResponseMessage = "Information has been removed successfully.";
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_REMOVE_FROM_AFFILIATION:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(CareHub.UnitOfWork.DoctorEditDetailsUOW));
                            unitOfWork.Delete(doctorEditDetails);
                            unitOfWork.Commit();
                            doctorEditDetails.ResponseMessage = "Information has been removed successfully.";
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_REMOVE_FROM_AWARD:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(CareHub.UnitOfWork.DoctorEditDetailsUOW));
                            unitOfWork.Delete(doctorEditDetails);
                            unitOfWork.Commit();
                            doctorEditDetails.ResponseMessage = "Information has been removed successfully.";
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.STAFF_REMOVE_FROM_PROVIDERS:
                            staff = (DomainModel.Models.Staff)domainModel;
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(CareHub.UnitOfWork.StaffUOW));
        ...
        public override AbstractDomainModel Query(AbstractDomainModel domainModel, CareHub.Factory.Enumerations.DomainModelEnum domainModelType)
        {
            try
            {
                if (domainModel != null)
                {
                    ...
                    switch (domainModelType)
                    {
                        case CareHub.Factory.Enumerations.DomainModelEnum.PROFILE_DETAILS:
                            editProfile = (DomainModel.Models.EditProfile)domainModel;
                            ...
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_DETAILS:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            ...
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_CONTACTS:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            if (doctorEditDetails.UserId == null || doctorEditDetails.UserId.Length <= 0)
                            {
                                doctorEditDetails.ResponseMessage = "User id is required";
                            ...
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_CONSULTATION:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            if (doctorEditDetails.UserId == null || doctorEditDetails.UserId.Length <= 0)
                            {
                                doctorEditDetails.ResponseMessage = "User id is required";
                            ...
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_ADDED_SPECIALIZATIONS:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            if (doctorEditDetails.UserId == null || doctorEditDetails.UserId.Length <= 0)
                            {
                                doctorEditDetails.ResponseMessage = "User id is required";
                            ...
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_ADDED_LANGUAGES:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            if (doctorEditDetails.UserId == null || doctorEditDetails.UserId.Length <= 0)
                            {
                                doctorEditDetails.ResponseMessage = "User id is required";
                            ...
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_ADDED_TREATMENTS:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            if (doctorEditDetails.UserId == null || doctorEditDetails.UserId.Length <= 0)
                            {
                                doctorEditDetails.ResponseMessage = "User id is required";
                            ...
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_ADDED_EDUCATION:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            if (doctorEditDetails.UserId == null || doctorEditDetails.UserId.Length <= 0)
                            {
                                doctorEditDetails.ResponseMessage = "User id is required";
                            ...
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_ADDED_EXPERIENCE:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            if (doctorEditDetails.UserId == null || doctorEditDetails.UserId.Length <= 0)
                            {
                                doctorEditDetails.ResponseMessage = "User id is required";
                            ...
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_ADDED_AFFILIATIONS:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            if (doctorEditDetails.UserId == null || doctorEditDetails.UserId.Length <= 0)
                            {
                                doctorEditDetails.ResponseMessage = "User id is required";
                            ...
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_ADDED_AWARDS:
                            doctorEditDetails = (DomainModel.Models.DoctorEditDetails)domainModel;
                            if (doctorEditDetails.UserId == null || doctorEditDetails.UserId.Length <= 0)
                            {
                                doctorEditDetails.ResponseMessage = "User id is required";
                            ...
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.STAFF_GET_ADDED_PRACTICE_DOCTORS:
                            staff = (DomainModel.Models.Staff)domainModel;
                            ...
                            break;
                        case CareHub.Factory.Enumerations.DomainModelEnum.STAFF_GET_ADDED_PRACTICE_STAFF:
                            staff = (DomainModel.Models.Staff)domainModel;
                            if (staff.UserId == null || staff.UserId.Length <= 0)
                            {
                                staff.ResponseMessage = "User id is required";
