...
(function () {
    ...
    function practicesController(practicesService, logger, $scope, $location, usSpinnerService, $rootScope, alertsManager) {
        ...
        function isValidEmail(emailAddress) {
            return practicesService.isValidEmail(emailAddress);
        }
        //-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
        //-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        function addPracticeDetails() {
            ...
            var name = practicesControllerVM.practiceDetailsName;
            var tagline = practicesControllerVM.practiceDetailsTagLine;
            var description = practicesControllerVM.practiceDetailsDescription;
            var billingCurrency = practicesControllerVM.practiceDetailsBillingCurrency;
            var type = practicesControllerVM.practiceDetailsType;
        ...
        function setPracticeDetails() {
            ...
            if (practicesControllerVM.practiceDetailPracticeDetailList.length > 0) {
                ...
                practicesControllerVM.practiceDetailsPracticeTypeName = practicesControllerVM.practiceDetailPracticeDetailList[0].practiceDetailsPracticeTypeName;
            }
        }
    ...
    //        var primaryEmailId = practicesControllerVM.PracticeContactsPrimaryEmail.trim();
    //        var secondaryEmailId = practicesControllerVM.PracticeContactsSecondaryEmail.trim();
    ...
    //}
        ...
        function addPracticeContacts(providerId) {
            $scope.reset();
            debugger;
            var primaryPhone = parseInt(practicesControllerVM.PracticeContactsPrimaryPhone);
            var secondaryPhone = parseInt(practicesControllerVM.PracticeContactsSecondaryPhone);
            var primaryEmailId = practicesControllerVM.PracticeContactsPrimaryEmail.trim();
            var secondaryEmailId = practicesControllerVM.PracticeContactsSecondaryEmail.trim();
            var websiteAddress = practicesControllerVM.PracticeContactsWebsiteAddress.trim();
            ...
            if (practicesControllerVM.isVisibleSecondaryEmailId == true && secondaryEmailId == '')
            { failureAlert("Secondary email id is required."); }
            if (practicesControllerVM.isVisibleSecondaryPhone == true && isNaN(secondaryPhone)) {
                failureAlert("Please enter valid secondary phone number.");
            }
            if (practicesControllerVM.isVisibleSecondaryEmailId == true && !isValidEmail(secondaryEmailId)) {
            ...
            if (primaryPhone != '' && (!isNaN(primaryPhone)) && primaryEmailId != '' && isValidEmail(primaryEmailId)) {
                ...
                if (practicesControllerVM.isVisibleSecondaryPhone == false && practicesControllerVM.isVisibleSecondaryEmailId == false) {
                    ...
                    practicesService.addPracticeContacts({
                        ...
                        $scope.reset();
                        $scope.stopSpin();
                        practicesControllerVM.getPracticeContacts(providerId);
                        successAlert(response);
                    });
                    practicesControllerVM.PracticeContactsPrimaryPhone = '';
                    practicesControllerVM.PracticeContactsSecondaryPhone = '';
                    practicesControllerVM.PracticeContactsPrimaryEmail = '';
                    practicesControllerVM.PracticeContactsSecondaryEmail = '';
                    practicesControllerVM.PracticeContactsWebsiteAddress = '';
                }
                    // Secondary phone visible
                else if (practicesControllerVM.isVisibleSecondaryPhone == true && secondaryPhone != '') {
        ...
        function addToPracticeTravelServices() {
            ...
            for (var i = 0 ; i < practicesControllerVM.travelServicesList.length; i++) {
                if (practicesControllerVM.travelServicesList[i].title == travelservices) {
                    travelserviceId = parseInt(practicesControllerVM.travelServicesList[i].serviceId);
                    break;
                }
            }
            practicesService.addToPracticeTravelServices({ serviceId: travelserviceId }).then(function (data) {
                var response = data.results;
                successAlert(response);
                $scope.reset();
                $scope.stopSpin();
        ...
        function removePracticeTravelServices(travelServiceId) {
            $scope.startSpin();
            practicesService.removePracticeTravelServices({ travelServiceId : travelServiceId }).then(function (data) {
                var response = data.results;
                $scope.reset();
                successAlert(response);
                practicesControllerVM.addedTravelServicesList();
