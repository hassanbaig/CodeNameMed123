...
namespace CareHub.Repository.RepositoryClasses
{
    public class ProviderEducationRepository : IRepository
    {
        ...
        public ProviderEducationRepository(shiner49_CareHubEntities context)
        {
            _context = context;
        }
        ...
        public List<CareHub.DataModel.Models.ProviderEducation> GetProviderEducation(long providerId)
        {
            var data = (from proedu in _context.ProviderEducations
                        where proedu.ProviderId == providerId
                        select new CareHub.DataModel.Models.ProviderEducation
                        {
