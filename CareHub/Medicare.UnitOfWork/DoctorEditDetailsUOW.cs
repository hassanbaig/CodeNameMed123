...
namespace CareHub.UnitOfWork
{
    public class DoctorEditDetailsUOW : BaseUnitOfWork,IUnitOfWork
    {
        ...
        public DoctorEditDetailsUOW(shiner49_medicareEntities context)
            : base(context)
        {
            if (context == null)
            {
        ...
        {             
         ...
         public AbstractDomainModel Get(AbstractDomainModel domainModel)
         {
            ...
            CareHub.DataModel.Models.ProviderContact providerContact = null;
            List<CareHub.DataModel.Models.ProviderAvailability> providerAvailability = null;
            CareHub.DataModel.Models.ProviderFee providerFee = null;
            List<CareHub.DataModel.Models.Specialty> providerAddedSpecializations = null;
            List<CareHub.DataModel.Models.Language> providerAddedLanguages = null;
            List<CareHub.DataModel.Models.Treatment> providerAddedTreatments = null;
            List<CareHub.DataModel.Models.ProviderEducation> providerAddedEducation = null;
            List<CareHub.DataModel.Models.ProviderExperience> providerAddedExperience = null;
            List<CareHub.DataModel.Models.ProviderAffiliation> providerAddedAffiliations = null;
            List<CareHub.DataModel.Models.ProviderAward> providerAddedAwards = null;
             ...
             switch (doctorEditDetails.OperationType)
             {
                 ...
                 case 3:
                     ...
                     {
                         foreach (CareHub.DataModel.Models.ProviderAvailability item in providerAvailability)
                         {
