...
namespace CareHub.WebAPI.Controllers
{
    ...
    {        
        ...
        //[AllowAnonymous]
        //[HttpGet]
        //public IHttpActionResult Authenticate(string userId, string password , string practiceId)
        //{            
        ...
        //    {
        //        UserData userData = new UserData(userId,authenticate.ProviderId.ToString(),"",practiceId);                
        //        TicketHelper.CreateAuthCookie(userData.UserId, userData.GetProviderUserData(),false,userData.PracticeId);
        //    }           
        ...
        {            
            FactoryFacade factory = new FactoryFacade();                                
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(AccountsDomainService));
            return ((DomainModel.Models.ProviderRegistration)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_SPECIALTIES)).Specialties.AsQueryable();            
        }
        [AllowAnonymous]
        [HttpGet]
        ...
        {            
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(AccountsDomainService));
            return ((DomainModel.Models.ProviderRegistration)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_COUNTRIES)).Countries.AsQueryable();            
        }
        [AllowAnonymous]
        [HttpGet]
        ...
        {            
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(AccountsDomainService));
            return ((DomainModel.Models.ProviderRegistration)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_CITIES)).Cities.AsQueryable();            
        }
        [AllowAnonymous]
        [HttpGet]
