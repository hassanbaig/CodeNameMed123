...
namespace CareHub.WebAPI.Controllers
{
    ...
    public class PracticesController : BaseController
    {
        ...
        public PracticeEditDetails GetPracticeDetails(long? providerId)
        {
          ...
          [HttpGet]
        public PracticeEditDetails GetPracticeLocation(long? providerId)
        {
            FactoryFacade factory = new FactoryFacade();
            string data = TicketHelper.GetDecryptedUserId();
            PracticeEditDetails practiceEditDetails = null;
            ...
            if (data != null)
            {
                ...
                domainModel = factory.DomainModelFactory.CreateDomainModel(typeof(PracticeEditDetails));
                if (providerId == 0)
                { domainModel.Fill(HashHelper.PracticeEditDetailsGetAddedInfo(dataList[0], Convert.ToInt64(dataList[1]), 22, 12)); }
                else
                { domainModel.Fill(HashHelper.PracticeEditDetailsGetAddedInfo(dataList[0], (long)providerId, 22, 12)); }
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                practiceEditDetails = ((DomainModel.Models.PracticeEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_GET_LOCATION)).PracticeInfo;
            }
            return practiceEditDetails;
        }
        ...
        //        domainModel = factory.DomainModelFactory.CreateDomainModel(typeof(PracticeEditDetails));
        //        if (providerId == 0)
        //        { domainModel.Fill(HashHelper.PracticeEditDetailsGetProviderPractices(dataList[0], Convert.ToInt64(dataList[1]), 11)); }
        //        else
        //        { domainModel.Fill(HashHelper.PracticeEditDetailsGetProviderPractices(dataList[0], (long)providerId, 11)); }
        //        domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
        //        practiceEditDetails = ((DomainModel.Models.PracticeEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_GET_PROVIDER_PRACTICES)).PracticeInfo;
        //    }
        //    return practiceEditDetails;
        //}
        ...
        //[HttpGet]
        //public IQueryable GetProviderPractices(long? providerId)
        //{
        //    FactoryFacade factory = new FactoryFacade();
        //    string data = TicketHelper.GetDecryptedUserId();
        //    if (data != null)
        ...
        //        }
        //        domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
        //        return ((DomainModel.Models.PracticeEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_GET_PROVIDER_PRACTICES)).ProviderPractice.AsQueryable();
        //    }
        //    return null;
        //}

        [HttpGet]
        public IQueryable GetProviderPractices()
        {
            FactoryFacade factory = new FactoryFacade();
            string data = TicketHelper.GetDecryptedUserId();
            if (data != null)
        ...
        public IHttpActionResult AddPracticeDetails(string uploadLogo, string name, string tagLine, string description, int billingCurrency, long type)
        {
            ...
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
            practiceEditDetails = (PracticeEditDetails)domainService.Save(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_ADD_DETAILS);
        ...
        public IQueryable GetPracticeBillingCurrency()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
            return ((DomainModel.Models.PracticeEditDetails)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_BILLING_CURRENCY)).BillingCurrency.AsQueryable();
        }
        ...
        public IQueryable GetPracticeType()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
            return ((DomainModel.Models.PracticeEditDetails)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_PRACTICE_TYPE)).PracticeType.AsQueryable();
        }
        ...
        public IQueryable GetCountries()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
            return ((DomainModel.Models.PracticeEditDetails)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_COUNTRIES)).Countries.AsQueryable();
        }

        //Contacts
        [HttpGet]
        public PracticeEditDetails GetPracticeContacts(long? providerId)
        {
            FactoryFacade factory = new FactoryFacade();
            string data = TicketHelper.GetDecryptedUserId();
            PracticeEditDetails practiceEditDetails = null;
            ...
            if (data != null)
            {
                ...
                domainModel = factory.DomainModelFactory.CreateDomainModel(typeof(PracticeEditDetails));
                if (providerId == 0)
                { domainModel.Fill(HashHelper.PracticeEditDetailsGetAddedInfo(dataList[0], Convert.ToInt64(dataList[1]), 7, 2)); }
                else
                { domainModel.Fill(HashHelper.PracticeEditDetailsGetAddedInfo(dataList[0], (long)providerId, 7, 2)); }
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                practiceEditDetails = ((DomainModel.Models.PracticeEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_GET_CONTACTS)).PracticeInfo;
        ...
        //    domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
        //    practiceEditDetails = (PracticeEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_ADD_CONTACTS);
        //    return Ok(practiceEditDetails.ResponseMessage);
        //}


        [HttpGet]
        public IHttpActionResult AddPracticeContacts(string primaryPhone, string primaryEmailId, long? providerId, string websiteAddress = "", string secondaryPhone = "", string secondaryEmailId = "")
        {
            PracticeEditDetails practiceEditDetails = null;
            string data = TicketHelper.GetDecryptedUserId();
            string[] dataList = data.Split(',');
            ...
            domainModel = factory.DomainModelFactory.CreateDomainModel(typeof(PracticeEditDetails));
            if (providerId == 0)
            { domainModel.Fill(HashHelper.PracticeEditDetailsAddPracticeContacts(2, dataList[0], Convert.ToInt64(dataList[1]), primaryPhone, primaryEmailId, websiteAddress, secondaryPhone, secondaryEmailId)); }
            else
            { domainModel.Fill(HashHelper.PracticeEditDetailsAddPracticeContacts(2, dataList[0], (long)providerId, primaryPhone, primaryEmailId, websiteAddress, secondaryPhone, secondaryEmailId)); }
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
            practiceEditDetails = (PracticeEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_ADD_CONTACTS);
            return Ok(practiceEditDetails.ResponseMessage);
        }
        ...
        //    doctorEditDetails = (DoctorEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_CONTACTS);
                                                                                                        ...
                                                                                                        string sunOpenHour2 = "", string sunOpenMinute2 = "", string sunCloseHours2 = "", string sunCloseMinutes2 = "")
        {
            ...
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
            practiceEditDetails = (PracticeEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_ADD_TO_TIMINGS);
            return Ok(practiceEditDetails.ResponseMessage);
        }
        ...
        public PracticeEditDetails GetPracticeTimings(long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                practiceEditDetails = ((DomainModel.Models.PracticeEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_GET_ADDED_TIMINGS)).PracticeInfo;
            }
            return practiceEditDetails;
        }
        ...
        public IQueryable GetServices()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
            return ((DomainModel.Models.PracticeEditDetails)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_SERVICES)).Services.AsQueryable();
        }
        ...
        public IQueryable GetAddedServices()
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                return ((DomainModel.Models.PracticeEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_GET_ADDED_SERVICES)).AddedServices.AsQueryable();
            }
            return null;
        }
        ...
        public IQueryable AddPracticeServices(string title)
        {
            if (title != null)
            {
                ...
                if (data != null)
                {
                    ...
                    domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                    return ((DomainModel.Models.PracticeEditDetails)domainService.Save(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_ADD_SERVICES)).Services.AsQueryable();
                }
            }
            else
            {
        ...
        public IHttpActionResult AddToPracticeServices(long serviceId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                practiceEditDetails = (PracticeEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_ADD_TO_SERVICES);
        ...
        public IHttpActionResult RemovePracticeServices(long serviceId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                practiceEditDetails = (PracticeEditDetails)domainService.Delete(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_REMOVE_FROM_SERVICES);
            }
            return Ok(practiceEditDetails.ResponseMessage);
        }
        ...
        public IQueryable GetTravelServices()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
            return ((DomainModel.Models.PracticeEditDetails)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_TRAVEL_SERVICES)).TravelServices.AsQueryable();
        ...
        public IQueryable GetAddedTravelServices()
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                return ((DomainModel.Models.PracticeEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_GET_ADDED_TRAVEL_SERVICES)).AddedTravelServices.AsQueryable();
            }
            return null;
        }
        ...
        public IQueryable AddPracticeTravelServices(string title)
        {
            if (title != null)
            {
                ...
                if (data != null)
                {
                    ...
                    domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                    return ((DomainModel.Models.PracticeEditDetails)domainService.Save(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_ADD_TRAVEL_SERVICES)).TravelServices.AsQueryable();
                }
            }
            else
            {
        ...
        public IHttpActionResult AddToPracticeTravelServices(long serviceId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                practiceEditDetails = (PracticeEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_ADD_TO_TRAVEL_SERVICES);
        ...
        public IHttpActionResult RemovePracticeTravelServices(long travelserviceId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                practiceEditDetails = (PracticeEditDetails)domainService.Delete(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_REMOVE_FROM_TRAVEL_SERVICES);
            }
            return Ok(practiceEditDetails.ResponseMessage);
        }
        ...
        public IQueryable GetPremises()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
            return ((DomainModel.Models.PracticeEditDetails)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_PREMISES)).Premises.AsQueryable();
        }
        ...
        public IQueryable GetAddedPremises()
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                return ((DomainModel.Models.PracticeEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_GET_ADDED_PREMISES)).AddedPremises.AsQueryable();
            }
            return null;
        }
        ...
        public IQueryable AddPracticePremises(string name)
        {
            if (name != null)
            {
                ...
                if (data != null)
                {
                    ...
                    domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                    return ((DomainModel.Models.PracticeEditDetails)domainService.Save(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_ADD_PREMISES)).Premises.AsQueryable();
                }
            }
            else
            {
        ...
        public IHttpActionResult AddToPracticePremises(long premisesId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                practiceEditDetails = (PracticeEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_ADD_TO_PREMISES);
        ...
        public IHttpActionResult RemovePracticePremises(long premisesId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                practiceEditDetails = (PracticeEditDetails)domainService.Delete(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_REMOVE_FROM_PREMISES);
            }
            return Ok(practiceEditDetails.ResponseMessage);
        ...
        public IQueryable GetLanguages()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
            return ((DomainModel.Models.PracticeEditDetails)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_LANGUAGES)).Languages.AsQueryable();
        }
        [HttpGet]
        public IQueryable GetAddedLanguages()
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                return ((DomainModel.Models.PracticeEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_GET_ADDED_LANGUAGES)).AddedLanguages.AsQueryable();
            }
            return null;
        }
        ...
        public IQueryable AddPracticeLanguages(string name)
        {
            if (name != null)
            {
                ...
                if (data != null)
                {
                    ...
                    domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                    return ((DomainModel.Models.PracticeEditDetails)domainService.Save(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_ADD_LANGUAGES)).Languages.AsQueryable();
                }
            }
            else
            {
        ...
        public IHttpActionResult AddToPracticeLanguages(long languageId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                practiceEditDetails = (PracticeEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_ADD_TO_LANGUAGES);
        ...
        public IHttpActionResult RemovePracticeLanguages(long languageId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                practiceEditDetails = (PracticeEditDetails)domainService.Delete(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_REMOVE_FROM_LANGUAGES);
            }
            return Ok(practiceEditDetails.ResponseMessage);
        }
        ...
        public IQueryable GetAccreditations()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
            return ((DomainModel.Models.PracticeEditDetails)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_ACCREDITATIONS)).Accreditations.AsQueryable();
        }
        ...
        public IQueryable GetAddedAccreditations()
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                return ((DomainModel.Models.PracticeEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_GET_ADDED_ACCREDITATIONS)).AddedAccreditations.AsQueryable();
            }
            return null;
        }
        ...
        public IQueryable AddPracticeAccreditations(string title)
        {
            if (title != null)
            {
                ...
                if (data != null)
                {
                    ...
                    domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                    return ((DomainModel.Models.PracticeEditDetails)domainService.Save(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_ADD_ACCREDITATIONS)).Accreditations.AsQueryable();
                }
            }
            else
            {
        ...
        public IHttpActionResult AddToPracticeAccreditations(long accreditationId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                practiceEditDetails = (PracticeEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_ADD_TO_ACCREDITATIONS);
        ...
        public IHttpActionResult RemovePracticeAccreditations(long accreditationId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                practiceEditDetails = (PracticeEditDetails)domainService.Delete(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_REMOVE_FROM_ACCREDITATIONS);
            }
            return Ok(practiceEditDetails.ResponseMessage);
        }
        ...
        public IQueryable GetInsurances()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
            return ((DomainModel.Models.PracticeEditDetails)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_INSURANCES)).Insurances.AsQueryable();
        }
        ...
        public IQueryable GetAddedInsurances()
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                return ((DomainModel.Models.PracticeEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_GET_ADDED_INSURANCES)).AddedInsurances.AsQueryable();
            }
            return null;
        }
        ...
        public IQueryable AddPracticeInsurances(string title)
        {
            if (title != null)
            {
                ...
                if (data != null)
                {
                    ...
                    domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                    return ((DomainModel.Models.PracticeEditDetails)domainService.Save(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_ADD_INSURANCES)).Insurances.AsQueryable();
                }
            }
            else
            {
        ...
        public IHttpActionResult AddToPracticeInsurances(long insuranceId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                practiceEditDetails = (PracticeEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_ADD_TO_INSURANCES);
        ...
        public IHttpActionResult RemovePracticeInsurances(long insuranceId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesDomainService));
                practiceEditDetails = (PracticeEditDetails)domainService.Delete(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_REMOVE_FROM_INSURANCES);
            }
            return Ok(practiceEditDetails.ResponseMessage);
        }
