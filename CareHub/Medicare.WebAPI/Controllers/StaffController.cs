...
namespace CareHub.WebAPI.Controllers
{
    ...
    public class StaffController : BaseController
    {
                                                ...
                                                string streetAddress, int countryId, int stateId, long cityId, long localityId, int zipCode)
        {
            ...
            editProfile = (EditProfile)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.EDIT_PROFILE);
        ...
        public IQueryable GetRegistrationCouncils()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            return ((DomainModel.Models.DoctorEditDetails)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_REGISTRATION_COUNCILS)).RegistrationCouncils.AsQueryable();
        }
                                                    ...
                                                    int? numberOfYears, long? providerId, string registrationDetails="", string doctorTagLine="", string doctorDescription="")
        {
            ...
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            return Ok(((DoctorEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_DETAILS)).ResponseMessage);            
        }
        ...
        public DoctorEditDetails GetDoctorDetails(long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                doctorEditDetails = ((DomainModel.Models.DoctorEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_DETAILS)).DoctorInfo;
            }
        ...
        public DoctorEditDetails GetDoctorContacts(long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                doctorEditDetails = ((DomainModel.Models.DoctorEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_CONTACTS)).DoctorInfo;
            }
            return doctorEditDetails;
        }        
                                                                                                        ...
                                                                                                        string sunOpenHour2 = "", string sunOpenMinute2 = "", string sunCloseHours2 = "", string sunCloseMinutes2 = "")
        {
            ...
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            doctorEditDetails = (DoctorEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_CONSULTATION);
            return Ok(doctorEditDetails.ResponseMessage);
        }
        ...
        public DoctorEditDetails GetDoctorConsultation(long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                doctorEditDetails = ((DomainModel.Models.DoctorEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_CONSULTATION)).DoctorInfo;
            }
            return doctorEditDetails;
        }        
        ...
        public EditProfile GetProfileDetails()
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                profile= ((DomainModel.Models.EditProfile)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.PROFILE_DETAILS)).ProfileDetails;
            }
            return profile;
        }
        ...
        public IQueryable GetCountries()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            return ((DomainModel.Models.EditProfile)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_COUNTRIES)).Countries.AsQueryable();
        }
        //[AllowAnonymous]
        [HttpGet]
        public IQueryable GetStates()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            return ((DomainModel.Models.EditProfile)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_STATES)).States.AsQueryable();
        }
        //[AllowAnonymous]
        [HttpGet]
        public IQueryable GetCities()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            return ((DomainModel.Models.EditProfile)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_CITIES)).Cities.AsQueryable();
        }
        //[AllowAnonymous]
        [HttpGet]
        public IQueryable GetLocalities()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            return ((DomainModel.Models.EditProfile)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_LOCALITIES)).Localities.AsQueryable();
        }
        ...
        {          
                FactoryFacade factory = new FactoryFacade();
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                return ((DomainModel.Models.DoctorEditDetails)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_SPECIALTIES)).Specialties.AsQueryable();        
        }        
        ...
        public IQueryable GetAddedSpecializations(long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                return ((DomainModel.Models.DoctorEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_ADDED_SPECIALIZATIONS)).AddedSpecialties.AsQueryable();
            }
            return null;
        }
        ...
        public IQueryable AddDoctorSpecializations(string name)
        {
            if (name != null)
            {
                ...
                if (data != null)
                {
                    ...
                    domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                    return ((DomainModel.Models.DoctorEditDetails)domainService.Save(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_SPECIALIZATIONS)).Specialties.AsQueryable();
                }
            }
            else
            {
        ...
        public IHttpActionResult AddToDoctorSpecializations(long specialtyId, long? providerId)
        {
            ...
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            doctorEditDetails = (DoctorEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_TO_SPECIALIZATIONS);
            }
            return Ok(doctorEditDetails.ResponseMessage);
        }        
        ...
        public IHttpActionResult RemoveDoctorSpecializations(long specialtyId, long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                doctorEditDetails = (DoctorEditDetails)domainService.Delete(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_REMOVE_FROM_SPECIALIZATIONS);
            }
            return Ok(doctorEditDetails.ResponseMessage);
        }
        ...
        public IQueryable GetLanguages()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            return ((DomainModel.Models.DoctorEditDetails)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_LANGUAGES)).Languages.AsQueryable();        
        }
        [HttpGet]
        public IQueryable GetAddedLanguages(long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                return ((DomainModel.Models.DoctorEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_ADDED_LANGUAGES)).AddedLanguages.AsQueryable();
            }
            return null;
        }
        ...
        public IQueryable AddDoctorLanguages(string name)
        {
            if (name != null)
            {
                ...
                if (data != null)
                {
                    ...
                    domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                    return ((DomainModel.Models.DoctorEditDetails)domainService.Save(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_LANGUAGES)).Languages.AsQueryable();
                }
            }
            else
            {
        ...
        public IHttpActionResult AddToDoctorLanguages(long languageId, long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                doctorEditDetails = (DoctorEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_TO_LANGUAGES);
            }
            return Ok(doctorEditDetails.ResponseMessage);
        }        
        ...
        public IHttpActionResult RemoveDoctorLanguages(long languageId, long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                doctorEditDetails = (DoctorEditDetails)domainService.Delete(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_REMOVE_FROM_LANGUAGES);
            }
            return Ok(doctorEditDetails.ResponseMessage);
        }
        ...
        public IQueryable GetTreatments()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            return ((DomainModel.Models.DoctorEditDetails)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_TREATMENTS)).Treatments.AsQueryable();
        }
        ...
        public IQueryable GetParentTreatments()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            return ((DomainModel.Models.DoctorEditDetails)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_PARENT_TREATMENTS)).ParentTreatments.AsQueryable();
        }
        ...
        public IQueryable GetAddedTreatments(long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                return ((DomainModel.Models.DoctorEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_ADDED_TREATMENTS)).AddedTreatments.AsQueryable();
            }
            return null;
        }
        ...
        public IHttpActionResult AddDoctorTreatments(string treatmentName, int? treatmentCost, int? tax, long? subcatecogyOf, long? providerId, string notes="")
        {
            ...
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            doctorEditDetails = (DoctorEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_TREATMENTS);
            return Ok(doctorEditDetails.ResponseMessage);
        }
        [HttpGet]
        public IHttpActionResult EditDoctorTreatments(long treatmentId, string treatmentName, int treatmentCost, int tax, long subcatecogyOf, string notes)
        {
            ...
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            doctorEditDetails = (DoctorEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_EDIT_TREATMENTS);
            return Ok(doctorEditDetails.ResponseMessage);
        }
        [HttpGet]
        public IHttpActionResult RemoveDoctorTreatments(long treatmentId, long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                doctorEditDetails = (DoctorEditDetails)domainService.Delete(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_REMOVE_FROM_TREATMENTS);
            }
            return Ok(doctorEditDetails.ResponseMessage);
        }
        [HttpGet]
        public IQueryable GetAddedEducation(long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                return ((DomainModel.Models.DoctorEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_ADDED_EDUCATION)).AddedEducation.AsQueryable();
            }
            return null;
        }
        [HttpGet]
        public IHttpActionResult AddDoctorEducation(string degreeTitle, int? degreeYear, long? providerId, string schoolTitle = "")
        {
            ...
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            doctorEditDetails = (DoctorEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_EDUCATION);
            return Ok(doctorEditDetails.ResponseMessage);
        }
        [HttpGet]
        public IHttpActionResult RemoveDoctorEducation(string degreeTitle, string schoolTitle, long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                doctorEditDetails = (DoctorEditDetails)domainService.Delete(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_REMOVE_FROM_EDUCATION);
            }
            return Ok(doctorEditDetails.ResponseMessage);
        }
        [HttpGet]
        public IQueryable GetAddedExperience(long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                return ((DomainModel.Models.DoctorEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_ADDED_EXPERIENCE)).AddedExperience.AsQueryable();
            }
            return null;
        }
        [HttpGet]
        public IHttpActionResult AddDoctorExperience(long? cityId, int? startYear, int? endYear, long? providerId, string designation="", string organization="")
        {
            ...
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            doctorEditDetails = (DoctorEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_EXPERIENCE);
            return Ok(doctorEditDetails.ResponseMessage);
        }
        [HttpGet]
        public IHttpActionResult RemoveDoctorExperience(string designation, string organization, long cityId, long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                doctorEditDetails = (DoctorEditDetails)domainService.Delete(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_REMOVE_FROM_EXPERIENCE);
            }
            return Ok(doctorEditDetails.ResponseMessage);
        }
        [HttpGet]
        public IHttpActionResult AddDoctorAffiliations(long affiliationId,int? year, long? providerId)
        {
            ...
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            doctorEditDetails = (DoctorEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_AFFILIATION);
            return Ok(doctorEditDetails.ResponseMessage);
        }
        [HttpGet]
        public IHttpActionResult RemoveDoctorAffiliations(long affiliationId, long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                doctorEditDetails = (DoctorEditDetails)domainService.Delete(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_REMOVE_FROM_AFFILIATION);
            }
            return Ok(doctorEditDetails.ResponseMessage);
        }
        [HttpGet]
        public IHttpActionResult AddDoctorAwards(long awardId, int? year, long? providerId)
        {
            ...
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            doctorEditDetails = (DoctorEditDetails)domainService.Update(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_ADD_AWARD);
            return Ok(doctorEditDetails.ResponseMessage);
        }
        [HttpGet]
        public IHttpActionResult RemoveDoctorAwards(long awardId, long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                doctorEditDetails = (DoctorEditDetails)domainService.Delete(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_REMOVE_FROM_AWARD);
            }
            return Ok(doctorEditDetails.ResponseMessage);
        }
        [HttpGet]
        public IQueryable GetAddedAffiliations(long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                return ((DomainModel.Models.DoctorEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_ADDED_AFFILIATIONS)).AddedAffiliations.AsQueryable();
            }
            return null;
        }
        [HttpGet]
        public IQueryable GetAddedAwards(long? providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                return ((DomainModel.Models.DoctorEditDetails)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.DOCTOR_EDIT_DETAILS_GET_ADDED_AWARDS)).AddedAwards.AsQueryable();
            }
            return null;
        }
        [HttpGet]
        public IQueryable GetDegrees()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            return ((DomainModel.Models.DoctorEditDetails)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_DEGREES)).Degrees.AsQueryable();
        }
        [HttpGet]
        public IQueryable GetColleges()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            return ((DomainModel.Models.DoctorEditDetails)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_COLLEGES)).Colleges.AsQueryable();
        }
        [HttpGet]
        public IQueryable GetAffiliations()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            return ((DomainModel.Models.DoctorEditDetails)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_AFFILIATIONS)).Affiliations.AsQueryable();
        }
        [HttpGet]
        public IQueryable GetAwards()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
            return ((DomainModel.Models.DoctorEditDetails)domainService.Query(CareHub.Core.Enumerations.SearchCriteriaEnum.GET_AWARDS)).Awards.AsQueryable();
        }
        [HttpGet]
        public IQueryable GetAllDoctorsByProviderPractice()
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                return ((DomainModel.Models.Staff)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.STAFF_GET_ADDED_PRACTICE_DOCTORS)).PracticeDoctors.AsQueryable();
            }
            return null;
        }
        [HttpGet]
        public IQueryable GetAllStaffByProviderPractice()
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                return ((DomainModel.Models.Staff)domainService.Query(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.STAFF_GET_ADDED_PRACTICE_STAFF)).PracticeStaff.AsQueryable();
            }
            return null;
        }
        [HttpGet]
        public IHttpActionResult RemoveProvider(long providerId)
        {
            ...
            if (data != null)
            {
                ...
                domainService = factory.DomainServiceFactory.CreateDomainService(typeof(StaffDomainService));
                staff = (Staff)domainService.Delete(domainModel, CareHub.Factory.Enumerations.DomainModelEnum.STAFF_REMOVE_FROM_PROVIDERS);
            }
