...
namespace Medicare.DomainModel.Models
{
    public class DoctorEditDetails:AbstractDomainModel
    {
        ...
        public List<Medicare.DataModel.Models.RegistrationCouncil> RegistrationCouncils { get; set; }
        ...
        public List<Medicare.DataModel.Models.Specialty> AddedSpecialties { get; set; }
        ...
        public List<Medicare.DataModel.Models.ProviderEducation> AddedEducation { get; set; }
        public List<Medicare.DataModel.Models.ProviderExperience> AddedExperience { get; set; }
        public List<Medicare.DataModel.Models.ProviderAffiliation> AddedAffiliations { get; set; }
        public List<Medicare.DataModel.Models.ProviderAward> AddedAwards { get; set; }
        public List<Medicare.DataModel.Models.Treatment> Treatments { get; set; }
        public List<Medicare.DataModel.Models.Treatment> ParentTreatments { get; set; }        
        public List<Medicare.DataModel.Models.Treatment> AddedTreatments { get; set; }
        public List<Medicare.DataModel.Models.Degree> Degrees { get; set; }
        public List<Medicare.DataModel.Models.College> Colleges { get; set; }
        public List<Medicare.DataModel.Models.Affiliation> Affiliations { get; set; }
        public List<Medicare.DataModel.Models.Award> Awards { get; set; }        
        #endregion        
