...
namespace Medicare.Repository.RepositoryClasses
{
    public class PracticeRepository : IRepository
    {
       ...
       private MedicareDevEntities _context;
        ...
        public PracticeRepository(MedicareDevEntities context)
        {
            _context = context;
        }
        ...
        public List<Medicare.DataModel.Models.Practice> GetPracticeByHospital(long city, string practice)
        {
            var practices = (from pra in _context.Practices
                             where pra.Name.Contains(practice) && pra.CityId == city && pra.PracticeTypeId == 2
                            select new Medicare.DataModel.Models.Practice
                            {
                                Name = pra.Name,
                                Address = pra.Address,
        ...
        public List<Medicare.DataModel.Models.Practice> GetPracticeByHospitalLocality(long city, string practice, string locality)
        {
            var practices = (from pra in _context.Practices
        ...
        public List<Medicare.DataModel.Models.Practice> GetPracticeByLab(long city, string lab)
        {
            var practices = (from pra in _context.Practices
        ...
        public List<Medicare.DataModel.Models.Practice> GetPracticeByLabLocality(long city, string lab, string locality)
        {
            var practices = (from pra in _context.Practices
                             join loc in _context.Localities on pra.LocalityId equals loc.LocalityId
        ...
        public List<Medicare.DataModel.Models.Practice> GetAllHospitals()
        {
        ...
        public List<Medicare.DataModel.Models.Practice> GetAllLabs()
        {
            var practice = (from pra in _context.Practices
