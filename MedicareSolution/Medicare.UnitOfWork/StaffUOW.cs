...
namespace Medicare.UnitOfWork
{
    public class StaffUOW : BaseUnitOfWork,IUnitOfWork
    {
        ...
        public StaffUOW(MedicareDevEntities context)
            : base(context)
        {
            if (context == null)
            {
        ...
        {             
         ...
         {
             staff = (Staff)domainModel;
             List<Medicare.DataModel.Models.Provider> practiceDoctors = null;
             List<Medicare.DataModel.Models.Provider> practiceStaff = null;
