...
{ 
    ...
    {        
        ...
        public IQueryable SearchProvider(long city, string locality, string specialty, string doctor, string hospital, string lab, string pharmacist, string nurse, string treatment, int searchType)
        {
            ...
            domainModel = domainService.Query(domainModel, Medicare.Factory.Enumerations.DomainModelEnum.DOCTOR_SEARCH);
        ...
        public IQueryable SearchPractice(long city, string locality, string hospital, string lab, int searchType)
        {
            ...
            domainModel = domainService.Query(domainModel, Medicare.Factory.Enumerations.DomainModelEnum.PRACTICE_SEARCH);
        ...
        public IQueryable GetCountries()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(DoctorsSearchDomainService));
            return ((DomainModel.Models.DoctorsSearch)domainService.Query(Medicare.Core.Enumerations.SearchCriteriaEnum.GET_COUNTRIES)).Countries.AsQueryable();
        }
        ...
        public IQueryable GetSpecialties()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(DoctorsSearchDomainService));
            return ((DomainModel.Models.DoctorsSearch)domainService.Query(Medicare.Core.Enumerations.SearchCriteriaEnum.GET_SPECIALTIES)).Specialties.AsQueryable();
        }
        ...
        public IQueryable GetDoctors()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(DoctorsSearchDomainService));
            return ((DomainModel.Models.DoctorsSearch)domainService.Query(Medicare.Core.Enumerations.SearchCriteriaEnum.GET_DOCTORS)).Doctors.AsQueryable();
        }
        ...
        public IQueryable GetHospitals()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesSearchDomainService));
            return ((DomainModel.Models.PracticesSearch)domainService.Query(Medicare.Core.Enumerations.SearchCriteriaEnum.GET_HOSPITALS)).Hospitals.AsQueryable();
        }
        ...
        public IQueryable GetLabs()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(PracticesSearchDomainService));
            return ((DomainModel.Models.PracticesSearch)domainService.Query(Medicare.Core.Enumerations.SearchCriteriaEnum.GET_LABS)).Labs.AsQueryable();
        }
        ...
        public IQueryable GetPharmacists()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(DoctorsSearchDomainService));
            return ((DomainModel.Models.DoctorsSearch)domainService.Query(Medicare.Core.Enumerations.SearchCriteriaEnum.GET_PHARMACISTS)).Pharmacists.AsQueryable();
        }
        ...
        public IQueryable GetNurse()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(DoctorsSearchDomainService));
            return ((DomainModel.Models.DoctorsSearch)domainService.Query(Medicare.Core.Enumerations.SearchCriteriaEnum.GET_NURSE)).Nurses.AsQueryable();
        }
        ...
        public IQueryable GetTreatments()
        {
            FactoryFacade factory = new FactoryFacade();
            domainService = factory.DomainServiceFactory.CreateDomainService(typeof(DoctorsSearchDomainService));
            return ((DomainModel.Models.DoctorsSearch)domainService.Query(Medicare.Core.Enumerations.SearchCriteriaEnum.GET_TREATMENTS)).Treatments.AsQueryable();
        }
