...
namespace Medicare.DomainModel.Models
{
    public class PracticeEditDetails:AbstractDomainModel
    {
      ...
      //  public List<Medicare.DataModel.Models.Practice> CityId { get; set; }
      ...
      public List<Medicare.DataModel.Models.Practice> Addedlocation { get; set; }
     ...
     //Services
        ...
        public List<Medicare.DataModel.Models.ProviderPractice> ProviderPractice { get; set; }
