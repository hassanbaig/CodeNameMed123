        ...
        public override AbstractDomainModel Save(AbstractDomainModel domainModel, Medicare.Factory.Enumerations.DomainModelEnum domainModelType)
        {
            ...
            try
            {
                if (domainModel != null)
                {
                    ...
                    {
                        case Medicare.Factory.Enumerations.DomainModelEnum.PROVIDER_REGISTRATION:
                            ...
                            else
                            {
                                ...
                                unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(Medicare.UnitOfWork.ProviderRegistrationUOW));
                                unitOfWork.Save(providerRegistration);
                                unitOfWork.Commit();
                                providerRegistration.ResponseMessage = "Registration is successful.";

                                Medicare.Core.ConfigurationEmails.ConfigurationEmail.SignupEmail(providerRegistration.Name, providerRegistration.Password, providerRegistration.Email);
                            }
                            break;
                        default:
                            break;
        ...
        public override AbstractDomainModel Update(AbstractDomainModel domainModel, Medicare.Factory.Enumerations.DomainModelEnum domainModelType)
        {
            ...
            try
            {
                if (domainModel != null)
                {
                    switch (domainModelType)
                    {
                        case Medicare.Factory.Enumerations.DomainModelEnum.CHANGE_PASSWORD:
                            ...
                            {
                                FactoryFacade factory = new FactoryFacade();
                                unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(Medicare.UnitOfWork.ChangePasswordUOW));
                                unitOfWork.Update(changePassword);
                                unitOfWork.Commit();
                                Medicare.Core.ConfigurationEmails.ConfigurationEmail.ChangePasswordEmail(changePassword.UserId, changePassword.NewPassword, changePassword.UserId);
                                changePassword.ResponseMessage = "Password changed successfully";
                            }
                            break;
                        case Medicare.Factory.Enumerations.DomainModelEnum.FORGOT_PASSWORD:
                            ...
                            {
                                FactoryFacade factory = new FactoryFacade();
                                unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(Medicare.UnitOfWork.ForgotPasswordUOW));
                                 ...
                                 */
                                Medicare.Core.ConfigurationEmails.ConfigurationEmail.ForgotPasswordEmail(forgotPassword.UserId, forgotPassword.NewPassword, forgotPassword.UserId);
        ...
        public override AbstractDomainModel Query(AbstractDomainModel domainModel, Medicare.Factory.Enumerations.DomainModelEnum domainModelType)
        {
            ...
            try
            {
                if (domainModel != null)
                {
                    switch (domainModelType)
                    {
                        case Medicare.Factory.Enumerations.DomainModelEnum.AUTHENTICATE:
                            ...
                            {
                                FactoryFacade factory = new FactoryFacade();
                                unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(Medicare.UnitOfWork.AuthenticateUOW));
