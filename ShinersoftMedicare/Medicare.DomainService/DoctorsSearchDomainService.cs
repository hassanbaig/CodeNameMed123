        ...
        public override AbstractDomainModel Query(AbstractDomainModel domainModel, Medicare.Factory.Enumerations.DomainModelEnum domainModelType)
        {
            ...
            try
            {
                if (domainModel != null)
                {
                    ...
                    {
                        case Medicare.Factory.Enumerations.DomainModelEnum.DOCTOR_SEARCH:
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(Medicare.UnitOfWork.DoctorsSearchUOW));
