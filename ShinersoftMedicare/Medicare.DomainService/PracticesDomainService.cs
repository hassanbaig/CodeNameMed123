            ...
            try
            {
                if (domainModel != null)
                {
                    ...
                    switch (domainModelType)
                    {
                        ...
                        case Medicare.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_ADD_TO_TIMINGS:
                            practiceEditDetails = (DomainModel.Models.PracticeEditDetails)domainModel;
                            unitOfWork = factory.UnitOfWorkFactory.CreateUnitOfWork(typeof(Medicare.UnitOfWork.PracticeEditDetailsUOW));
                            unitOfWork.Update(practiceEditDetails);
                            unitOfWork.Commit();
        ...
        public override AbstractDomainModel Query(AbstractDomainModel domainModel, Medicare.Factory.Enumerations.DomainModelEnum domainModelType)
        {
            ...
            try
            {
                if (domainModel != null)
                {
                    ...
                    switch (domainModelType)
                    {
                            case Medicare.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_GET_DETAILS:
                            practiceEditDetails = (DomainModel.Models.PracticeEditDetails)domainModel;
                            ...
                            case Medicare.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_GET_LOCATION:
                            practiceEditDetails = (DomainModel.Models.PracticeEditDetails)domainModel;
                            if (practiceEditDetails.UserId == null || practiceEditDetails.UserId.Length <= 0)
                            {
                                practiceEditDetails.ResponseMessage = "User id is required";
                            ...
                            // Practice for Pop
                            case Medicare.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_GET_PROVIDER_PRACTICES:
                            practiceEditDetails = (DomainModel.Models.PracticeEditDetails)domainModel;
                            if (practiceEditDetails.UserId == null || practiceEditDetails.UserId.Length <= 0)
                            {
                                practiceEditDetails.ResponseMessage = "User id is required";
                            ...
                            case Medicare.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_GET_CONTACTS:
                            practiceEditDetails = (DomainModel.Models.PracticeEditDetails)domainModel;
                            if (practiceEditDetails.UserId == null || practiceEditDetails.UserId.Length <= 0)
                            {
                                practiceEditDetails.ResponseMessage = "User id is required";
                        ...
                        case Medicare.Factory.Enumerations.DomainModelEnum.PRACTICE_EDIT_DETAILS_GET_ADDED_TIMINGS:
                            practiceEditDetails = (DomainModel.Models.PracticeEditDetails)domainModel;
                            if (practiceEditDetails.UserId == null || practiceEditDetails.UserId.Length <= 0)
                            {
                                practiceEditDetails.ResponseMessage = "User id is required";
