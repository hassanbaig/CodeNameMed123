...
using Medicare.Repository.Base;
...
namespace Medicare.Repository.RepositoryClasses
{
    public class ProviderRepository : BaseRepository, IRepository
    {
        ...
        public Medicare.DataModel.Models.Provider GetProviderByUserId(string userId)
        {
            var data = (from pro in _context.Providers
                        where pro.UserId == userId
                        select new Medicare.DataModel.Models.Provider
                        {
        ...
        #endregion
        public List<Medicare.DataModel.Models.Provider> GetProviderBySpecialty(long city, string specialty)
        {
            var data = (from pro in _context.Providers
                        ...
                        select pro).AsEnumerable().Select(x => new Medicare.DataModel.Models.Provider
                            {
        ...
        public List<Medicare.DataModel.Models.Provider> GetProviderBySpecialtyLocality(long city, string specialty, string locality)
        {
            var data = (from pro in _context.Providers
                        join proPra in _context.ProviderPractices on pro.ProviderId equals proPra.ProviderId
                        join pra in _context.Practices on proPra.PracticeId equals pra.PracticeId
        ...
        public List<Medicare.DataModel.Models.Provider> GetProviderByDoctor(long city, string doctor)
        {
        ...
        public List<Medicare.DataModel.Models.Provider> GetProviderByDoctorLocality(long city, string doctor, string locality)
        {
            string[] name = doctor.Split(' ');
            string fName = name[0];
            string lName = name[name.Length - 1];
        ...
        public List<Medicare.DataModel.Models.Provider> GetProviderByHospital(long city, string hospital)
        {
            var data = (from pro in _context.Providers
                        join proPra in _context.ProviderPractices on pro.ProviderId equals proPra.ProviderId
                        join pra in _context.Practices on proPra.PracticeId equals pra.PracticeId
        ...
        public List<Medicare.DataModel.Models.Provider> GetProviderByHospitalLocality(long city, string hospital, string locality)
        {
            var data = (from pro in _context.Providers
                        join proPra in _context.ProviderPractices on pro.ProviderId equals proPra.ProviderId
                        join pra in _context.Practices on proPra.PracticeId equals pra.PracticeId
        ...
        public List<Medicare.DataModel.Models.Provider> GetProviderByLab(long city, string lab)
        {
            var data = (from pro in _context.Providers
                        join proPra in _context.ProviderPractices on pro.ProviderId equals proPra.ProviderId
                        join pra in _context.Practices on proPra.PracticeId equals pra.PracticeId
        ...
        public List<Medicare.DataModel.Models.Provider> GetProviderByLabLocality(long city, string lab, string locality)
        {
            var data = (from pro in _context.Providers
                        join proPra in _context.ProviderPractices on pro.ProviderId equals proPra.ProviderId
                        join pra in _context.Practices on proPra.PracticeId equals pra.PracticeId
        ...
        public List<Medicare.DataModel.Models.Provider> GetProviderByPharmacist(long city, string pharmacist)
        {
        ...
        public List<Medicare.DataModel.Models.Provider> GetProviderByPharmacistLocality(long city, string pharmacist, string locality)
        {
            string[] name = pharmacist.Split(' ');
            string fName = name[0];
            string lName = name[name.Length - 1];
        ...
        public List<Medicare.DataModel.Models.Provider> GetProviderByNurse(long city, string nurse)
        {
        ...
        public List<Medicare.DataModel.Models.Provider> GetProviderByNurseLocality(long city, string nurse, string locality)
        {
            string[] name = nurse.Split(' ');
            string fName = name[0];
            string lName = name[name.Length - 1];
        ...
        public List<Medicare.DataModel.Models.Provider> GetProviderByTreatment(long city, string treatment)
        {
            var data = (from pro in _context.Providers
        ...
        public List<Medicare.DataModel.Models.Provider> GetProviderByTreatmentLocality(long city, string treatment, string locality)
        {
            var data = (from pro in _context.Providers
                        join proTre in _context.ProviderTreatments on pro.ProviderId equals proTre.ProviderId
                        join tre in _context.Treatments on proTre.TreatmentId equals tre.TreatmentId
        ...
        public List<Medicare.DataModel.Models.Provider> GetAllDoctors()
        {
            var data = (from pro in _context.Providers
        ...
        public List<Medicare.DataModel.Models.Provider> GetAllPharmacists()
        {
            var data = (from pro in _context.Providers
        ...
        public List<Medicare.DataModel.Models.Provider> GetAllNurses()
        {
            var data = (from pro in _context.Providers
        ...
        public Medicare.DataModel.Models.Provider GetDoctorDetailsById(string userId, long providerId)
        {
            var data = (from pro in _context.Providers
        ...
        //Practice Detail
        //public Medicare.DataModel.Models.Practice GetPracticeDetailsById(string userId, long practiceId)
        //{
        //    var data = (from pra in _context.Practices
        //                where pra.PracticeId == practiceId
        //                select pra).AsEnumerable().Select(x => new Medicare.DataModel.Models.Practice
        //                {
        ...
        public Medicare.DataModel.Models.Practice GetPracticeLocation(string userId, long practiceId)
        {
            var data = (from pra in _context.Practices
        ...
        public List<Medicare.DataModel.Models.ProviderPractice> GetProviderPractices(string userId, long providerId)
        {
            var data = (from proPra in _context.ProviderPractices
                        where proPra.ProviderId == providerId
                        select new Medicare.DataModel.Models.ProviderPractice
                        {
        ...
        public Medicare.DataModel.Models.ProviderContact GetPracticeContactsById(string userID, long providerId, long practiceId)
        {
            var data = (from pra in _context.Practices
                        ...
                        select pra).AsEnumerable().Select(x => new Medicare.DataModel.Models.ProviderContact
                        {
        ...
        public Medicare.DataModel.Models.ProviderContact GetDoctorContactsById(long providerId)
        {
            var data = (from proCon in _context.ProviderContacts
                        where proCon.ProviderId == providerId
                        select proCon).AsEnumerable().Select(x => new Medicare.DataModel.Models.ProviderContact
                            {
                                PrimaryPhone = (x.PrimaryPhone != null) ? x.PrimaryPhone : string.Empty,
                                SecondaryPhone = (x.SecondaryPhone != null) ? x.SecondaryPhone : string.Empty,
                                PrimaryEmail = (x.PrimaryEmail != null) ? x.PrimaryEmail : string.Empty,
        ...
        public List<Medicare.DataModel.Models.ProviderAvailability> GetDoctorTimingsById(long providerId)
        {
            var data = (from proAva in _context.ProviderAvailabilities
                        where proAva.ProviderId == providerId
                        select proAva).AsEnumerable().Select(x => new Medicare.DataModel.Models.ProviderAvailability
                            {
        ...
        //public List<Medicare.DataModel.Models.ProviderTiming> GetPracticeTimingsById(long providerId)
        //{
        //    var data = (from proTim in _context.ProviderTimings
        //                where proTim.ProviderId == providerId
        //                select proTim).AsEnumerable().Select(x => new Medicare.DataModel.Models.ProviderTiming
        //                {
        ...
        public Medicare.DataModel.Models.ProviderFee GetDoctorFeeById(long providerId)
        {
            var data = (from proFee in _context.ProviderFees
                        where proFee.ProviderId == providerId
                        select proFee).AsEnumerable().Select(x => new Medicare.DataModel.Models.ProviderFee
                            {
        ...
        public List<Medicare.DataModel.Models.Specialty> GetAddedSpecializations(string userId, long providerId)
        {
        ...
        public List<Medicare.DataModel.Models.Language> GetAddedLanguages(string userId, long providerId)
        {
        ...
        public List<Medicare.DataModel.Models.Premises> GetAddedPremises(string userId, long providerId)
        {
        ...
        public List<Medicare.DataModel.Models.Accreditation> GetAddedAccreditations(string userId, long providerId)
        {
        ...
        public List<Medicare.DataModel.Models.Insurance> GetAddedInsurances(string userId, long providerId)
        {
        ...
        public List<Medicare.DataModel.Models.Service> GetAddedServices(string userId, long providerId)
        {
        ...
        public List<Medicare.DataModel.Models.Service> GetAddedTravelServices(string userId, long providerId)
        {
        ...
        public List<Medicare.DataModel.Models.Treatment> GetAddedTreatments(string userId, long providerId)
        {
        ...
        public List<Medicare.DataModel.Models.Provider> GetAllDoctorsByProviderPractice()
        {
            var data = (from pro in _context.Providers
        ...
        public List<Medicare.DataModel.Models.Provider> GetAllStaffByProviderPractice()
        {
            var data = (from pro in _context.Providers
                        join proTyp in _context.ProviderTypes on pro.ProviderTypeId equals proTyp.ProviderTypeId
                        join usr in _context.Users on pro.UserId equals usr.UserId
