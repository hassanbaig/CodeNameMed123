...
namespace Medicare.UnitOfWork
{
    public class PracticeEditDetailsUOW : BaseUnitOfWork,IUnitOfWork
    {
       ...
       private ProviderTimingsRepository providerTimingsRepository;
        ...
        public PracticeEditDetailsUOW(shiner49_medicareEntities context)
            : base(context)
        {
            if (context == null)
            {
        ...
        void IUnitOfWork.InitializeRepositories()
        {
         ...
         {
            Medicare.DataModel.Models.Practice practice = null;
            Medicare.DataModel.Models.Practice practiceLocation = null;
             Medicare.DataModel.Models.ProviderContact providerContacts = null;
             ...
             List<Medicare.DataModel.Models.ProviderTiming> providerAddedTimings = null;
             List<Medicare.DataModel.Models.ProviderPractice> providerPractices = null;
             ...
             switch(practiceEditDetails.OperationType)
             {
                 ...
                 case 3:
                     ...
                     {
                         foreach (Medicare.DataModel.Models.ProviderTiming item in providerAddedTimings)
                         {
